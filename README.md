# Openpilot Configurator

This is the front-end to the Configurator.
It is used to share links to your configuration of openpilot, including the hardware you're using to get it working, steps required to reproduce the configuration, etc.
